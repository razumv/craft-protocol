...
- coordinators keep candidate, gate, verdict, progress, merge/deploy, and completion evidence project-local and send no unsolicited reports to the owner-facing architecture session, which is a system maintainer rather than a project supervisor;
