...
CURRENT_PROTOCOL_LABELS = {"protocol-version::3.4.36", "protocol-version::3.4.37", "protocol-version::3.4.38", "protocol-version::3.4.39", "protocol-version::3.4.40"}
STRICT_COMPLETION_PROTOCOL_LABELS = {"protocol-version::3.4.37", "protocol-version::3.4.38", "protocol-version::3.4.39", "protocol-version::3.4.40"}
    ...
    if increment.get("stage") == "complete":
        ...
        if strict_completion:
            ...
            if not isinstance(certificate_ref, dict):
                fail("v3.4.40 complete Product Increment requires consumed completion certificate")
            ...
            if len(merged_stories) != 1:
                fail("v3.4.40 completion certificate consumes exactly one merged workUnit")
...
def build_report(project: str, now: int) -> dict[str, Any]:
    ...
    # This public classification applies only to current v3.4.40 snapshots;
