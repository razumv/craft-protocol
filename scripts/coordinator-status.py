...
# Status publication remains able to read prior v3.4.36–v3.4.40 records.
CURRENT_PROTOCOL_LABELS = {"protocol-version::3.4.36", "protocol-version::3.4.37", "protocol-version::3.4.38", "protocol-version::3.4.39", "protocol-version::3.4.40", "protocol-version::3.4.41"}
STRICT_COMPLETION_PROTOCOL_LABELS = {"protocol-version::3.4.37", "protocol-version::3.4.38", "protocol-version::3.4.39", "protocol-version::3.4.40", "protocol-version::3.4.41"}
    ...
    if increment.get("stage") == "complete":
        ...
        if strict_completion:
            ...
            if not isinstance(certificate_ref, dict):
                fail("v3.4.41 complete Product Increment requires consumed completion certificate")
            ...
            if len(merged_stories) != 1:
                fail("v3.4.41 completion certificate consumes exactly one merged workUnit")
...
def build_report(project: str, now: int) -> dict[str, Any]:
    ...
    # This public classification applies only to current v3.4.41 snapshots;
