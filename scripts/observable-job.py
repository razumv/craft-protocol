...
def require_admitted_v3435(session_id: str, cwd: str) -> None:
    ...
    if not ({"protocol-version::3.4.35", "protocol-version::3.4.36", "protocol-version::3.4.37", "protocol-version::3.4.38", "protocol-version::3.4.39", "protocol-version::3.4.40"} & set(manifest.get("labels") or [])):
